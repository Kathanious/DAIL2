...
xcopy "%BATCH_DIR%\_Bag_of_Holding\DAIL2\modes\b_unique\database" /s "%BATCH_DIR%\DAIL_b\database" 
xcopy "%BATCH_DIR%\_Bag_of_Holding\DAIL2\modes\s_unique\database" /s "%BATCH_DIR%\DAIL_s\database" 
xcopy "%BATCH_DIR%\_Bag_of_Holding\DAIL2\modes\x_unique\database" /s "%BATCH_DIR%\DAIL_x\database" 
xcopy "%BATCH_DIR%\_Bag_of_Holding\DAIL2\modes\sx_unique\database" /s "%BATCH_DIR%\DAIL_sx\database" 
xcopy "%BATCH_DIR%\_Bag_of_Holding\DAIL2\modes\sd_unique\database" /s "%BATCH_DIR%\DAIL_sd\database" 
xcopy "%BATCH_DIR%\_Bag_of_Holding\DAIL2\modes\ep_unique\database" /s "%BATCH_DIR%\DAIL_ep\database" 
